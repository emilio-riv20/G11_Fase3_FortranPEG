...
parsingExpression
  = pluck
  / sym:'!' assertion:(annotated/predicate) { //asercion negativa
    return new n.PosAssertion(assertion);
  }
  / sym:'&' assertion:(annotated/predicate) { //asercion positiva
...
match
  ...
  / "(" _ op:(opciones/predicate) _ ")" {return new n.Parentesis(op)}
